  ...
  return cek ? (
    <>
      <Disclosure defaultOpen={isOpen}>
        {({ open }) => (
          <>
            <Disclosure.Button className='mt-1 flex w-full items-center justify-start gap-2 rounded py-2 pl-3 text-gray-500 outline-none transition-all hover:text-blue-600 focus-visible:outline-none focus-visible:ring focus-visible:ring-sky-500 dark:text-neutral-400 dark:hover:text-sky-500'>
