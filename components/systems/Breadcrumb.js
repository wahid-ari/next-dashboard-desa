    ...
    >
      <ol className="inline-flex whitespace-nowrap flex-nowrap items-center space-x-1 md:space-x-2">
        <li className="inline-flex items-center">
          <Link href="/" passHref className="transition-all font-semibold inline-flex items-center text-gray-500 dark:text-neutral-400 hover:text-gray-700 dark:hover:text-neutral-200">
            ...
            if (index === paths.length - 1) {
              return (
                <li aria-current="page" key={index} className="flex items-center">
                  ...
                  <span className="ml-1 font-semibold text-blue-600 dark:text-sky-500 mr-4">
