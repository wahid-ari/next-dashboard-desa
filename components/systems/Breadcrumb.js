      ...
      <ol className='inline-flex flex-nowrap items-center space-x-1 whitespace-nowrap md:space-x-1'>
        <li className='inline-flex items-center'>
          <Link
            href='/'
            passHref
            className='inline-flex items-center rounded text-gray-500 transition-all hover:text-gray-700 focus-visible:outline-none focus-visible:ring focus-visible:ring-sky-500 dark:text-neutral-400 dark:hover:text-neutral-200'
          >
