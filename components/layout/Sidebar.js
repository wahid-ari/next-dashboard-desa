  ...
  return (
    ...
    >
      ...
      <div className="flex justify-between items-center gap-2 px-4">
        <button className="lg:hidden focus-visible:outline-none focus-visible:ring focus-visible:ring-sky-500 rounded" onClick={hideMenu} id="closemenu" aria-label="Close Menu">
